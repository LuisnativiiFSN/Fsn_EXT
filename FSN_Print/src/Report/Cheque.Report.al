    ...
    dataset
    {
        ...
        dataitem(GenJnlLine; "Gen. Journal Line")
        {
            ...
            dataitem(CheckPages; "Integer")
            {
                ...
                column(CuentaText; CuentaText[1])
                {
                }
                column(CuentaText2; CuentaText[2])
                {
                }
                ...
                dataitem(PrintSettledLoop; "Integer")
                {
                    ...
                    begin
                        if not TestPrint then begin
                                ...
                                case ApplyMethod of
                                    ApplyMethod::OneLineOneEntry:
                                        begin
                                            ...
                                            CurrentLineAmount := LineAmount2;
                                            FoundLast := true;
                                            AmounTextL := FSNUTILITY.Num2Text(CurrentLineAmount) + '  Centavos*****';
                                        end;
                                    ...
                                    ApplyMethod::MoreLinesOneEntry:
                                        begin
                                            ...
                                            if GenJnlLine2."Applies-to Doc. No." = '' then begin
                                                ...
                                                AmounTextL := FSNUTILITY.Num2Text(LineAmount) + '  Centavos*****';
                                            end else
                                                case BalancingType of
                            ...
                            LineDiscount := 0;
                            PostingDesc := '';//160120
                            AmounTextL := FSNUTILITY.Num2Text(139.29) + '  Centavos*****';
                        end;
            ...
            begin
                ...
                if not TestPrint then begin
                    ...
                    if BankAcc."Bank Account No." <> '' then
                    ...
                    CheckDateText := 'S.S ' + DelChr(
                      ChkTransMgt.FormatDate("Posting Date", CheckDateFormat, DateSeparator, CheckLanguage, DateIndicator), '=', 'de');
