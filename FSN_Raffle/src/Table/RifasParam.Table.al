table 50100 "FSN RifasParam"
{
    ...
    fields
    {
        ...
        field(300; Fecha; Date)
        {
            Caption = 'Date';
        }
        field(350; FechaFin; Date)
        {
        }
        field(400; PremiosTotales; Integer)
        {
            Caption = 'Total Prizes';
        }
        field(410; PremiosOtorgados; Integer)
        {
    ...
    keys
    {
        key(Key1; "No Rifa", "Store No", Fecha)
        {
            Clustered = true;
        }
    }
