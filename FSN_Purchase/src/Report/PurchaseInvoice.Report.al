report 50078 PurchaseInvoice
{
    DefaultLayout = RDLC;
    RDLCLayout = 'src/Report/PurchaseInvoice.rdl';
    ...
    dataset
    {
        dataitem("Purch. Inv. Header"; "Purch. Inv. Header")
        {
            ...
            column(FacProv; "Vendor Invoice No.")
            {
            }
            column(UserID; "User ID")
            {
            }
            column(ShipToName_PIH; "Ship-to Name")
            {
            }
            column(ShipToAddress_PIH; "Ship-to Address")
            {
            }
            column(ShipToAddress2_PIH; "Ship-to Address 2")
            {
            }
