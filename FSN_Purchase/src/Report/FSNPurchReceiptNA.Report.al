report 50080 "FSN Purch. Receipt NA"
{
    ApplicationArea = All;
    UsageCategory = Administration;
    PreviewMode = PrintLayout;
    DefaultLayout = RDLC;
    RDLCLayout = 'src/Report/Layout/FSNPurchReceiptNA.rdl';
    Caption = 'FSN Purchase Receipt';
    ...
    dataset
    {
        dataitem("Purch. Rcpt. Header"; "Purch. Rcpt. Header")
        {
            ...
            RequestFilterFields = "Order No.", "LSC Receiving/Picking No.";
            RequestFilterHeading = 'FSN Purchase Receipt';
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(SubTotal; "Purch. Rcpt. Header".SubTotal)
                    {
                    }
                    column(Tax; "Purch. Rcpt. Header".Tax)
                    {
                    }
                    column(Total; "Purch. Rcpt. Header".Total)
                    {
                    }
                    ...
                    column(Numerorecepciondecompra; 'Número recepción de compra:')
                    {
                    }
                    column(Fecharecepciondecompra; 'Fecha recepción de compra:')
                    {
                    }
                    column(PostingDate; "Purch. Rcpt. Header"."Posting Date")
                    {
                    }
                    column(NumerodePedido; 'Numero de Pedido:')
                    {
                    }
                    column(FechadePedido; 'Fecha de Pedido:')
                    {
                    }
                    column(IdProveedor; 'Id. Proveedor:')
                    {
                    }
    ...
    begin
        ...
        "Purch. Rcpt. Header".SetRange("Order No.", 'PED00105918');
        "Purch. Rcpt. Header".SetRange("LSC Receiving/Picking No.", 'PRM000015505');
